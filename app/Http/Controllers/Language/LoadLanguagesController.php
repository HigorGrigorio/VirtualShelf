...
class LoadLanguagesController extends Controller implements IController
{
    ...
    public function handle(Request $request): Factory|Application|View|\Illuminate\Contracts\Foundation\Application|RedirectResponse
    {
        try {
            ...
            if ($result->isRejected()) {
                ...
                $return = view('language.index', compact('pagination'))->with(array_merge(
                    $this->getAlerts(),
                    $this->getRecordArgs(),
                    $args
                ));
