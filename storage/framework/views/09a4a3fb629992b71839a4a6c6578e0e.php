...
<?php $component->withAttributes([]); ?>
    <div class="container px-0">
        <div class="pt-4 pb-3 container-fluid d-flex flex-row justify-content-between px-0">
            <div>
                <a href="<?php echo e(route('tables.language.create')); ?>" class="btn btn-dark">
                    <i class="fas fa-plus"></i>
                    <span class="ms-2">Add</span>
                </a>
            </div>
            <form action="<?php echo e(route('tables.language.index')); ?>" method="get"
...
<?php endif; ?>
<?php /**PATH C:\Users\higor\PhpstormProjects\VirtualShelf\resources\views/layout/language/index.blade.php ENDPATH**/ ?>