                ...
                <div class="row g-0">
                    <div class="card-body">
                        ...
                        <div class="row pt-1">
                            ...
                            <div class="col-6 mb-3">
                                <h6>Acronym</h6>
                                <p class="text-muted"><?php echo e($record['acronym']); ?></p>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div class="d-flex justify-content-start">
                                <a href="<?php echo e(route('tables.language.edit', ['id' => $record['id']])); ?>"
                                   role="button"
                                   class="btn btn-link btn-rounded btn-sm fw-bold"
                                   data-mdb-ripple-color="dark">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <a href="<?php echo e(route('tables.language.destroy', ['id' => $record['id']])); ?>"
                                   role="button"
                                   class="btn btn-link btn-rounded btn-sm fw-bold"
                                   data-mdb-ripple-color="dark">
                            ...
                            <a href="<?php echo e(route('tables.language.index')); ?>"
                               role="button"
...
<?php endif; ?>
<?php /**PATH C:\Users\higor\PhpstormProjects\VirtualShelf\resources\views/layout/language/show.blade.php ENDPATH**/ ?>