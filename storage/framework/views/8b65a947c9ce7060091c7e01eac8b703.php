...
<?php $component->withAttributes([]); ?>
    <div class="pt-lg-5 d-flex align-items-center">
        <div class="container-sm d-flex flex-column w-75">
            <div class="pb-4">
                <h1>Editing language <?php if(isset($record)): ?>
                        <?php echo e($record['name']); ?> (<?php echo e($record['acronym']); ?>)
                    <?php endif; ?>.</h1>
            </div>
            <form action="<?php echo e(url('tables/language/update/' . $record['id'])); ?>" method="POST">
                <?php echo csrf_field(); ?>

                <?php if (isset($component)) { $__componentOriginal786b6632e4e03cdf0a10e8880993f28a = $component; } ?>
<?php $component = App\View\Components\Input::resolve(['type' => 'text','id' => 'name','name' => 'name','label' => 'Language','help' => 'if you change a name, the language will be registered as a new one','value' => isset($record) ? $record['name'] : null] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal786b6632e4e03cdf0a10e8880993f28a = $component; } ?>
<?php $component = App\View\Components\Input::resolve(['type' => 'text','id' => 'acronym','name' => 'acronym','label' => 'Language Acronym','help' => 'The acronym language must be 2 characters long in accordance with ISO 639-1:2002','value' => isset($record) ? $record['acronym'] : null] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Input::class))->getConstructor()): ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\higor\PhpstormProjects\VirtualShelf\resources\views/layout/language/edit.blade.php ENDPATH**/ ?>