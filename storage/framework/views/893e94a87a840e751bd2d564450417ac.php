                ...
                <table class="table align-middle mb-0 bg-white">
                    ...
                    <?php $__currentLoopData = $pagination; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <th><?php echo e($row->slug); ?></th>
                            <th><?php echo e($row->description); ?></th>
                            <td>
                                <a href="<?php echo e(route('tables.category.edit', ['id' => $row->id])); ?>"
                                   role="button"
                                ...
                                <button
                                    data-href="<?php echo e(route('tables.category.destroy', ['id' => $row->id])); ?>"
                                    data-mdb-toggle="modal"
                                    data-mdb-target="#confirm-modal"
                                    class="btn btn-link btn-rounded btn-sm fw-bold">
                                    <i class="fa fa-trash"></i>
                                </button>
                                <a href="<?php echo e(route('tables.category.show', ['id' => $row->id])); ?>"
                                   role="button"
                                   class="btn btn-link btn-rounded btn-sm fw-bold"
                                   data-mdb-ripple-color="dark">
                                    <i class="fa fa-eye"></i>
