                ...
                <div class="row g-0">
                    <div class="card-body">
                        ...
                        <div class="mt-3 mb-4 text-center w-100">
                            <img src="<?php echo e($record['icon'] ?? asset('images/default-photo.jpg')); ?>" class="img-fluid" style="width: 100px;">
                        </div>
                        <h6>Information</h6>
                        <hr class="mt-0 mb-4">
                        <div class="row pt-1">
                            ...
                            <div class="col-6 mb-3">
                                <h6>Country code</h6>
                                <p class="text-muted"><?php echo e($record['code']); ?></p>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div class="d-flex justify-content-start">
                                <a href="<?php echo e(route('tables.country.edit', ['id' => $record['id']])); ?>"
                                   role="button"
                                   class="btn btn-link btn-rounded btn-sm fw-bold"
                                   data-mdb-ripple-color="dark">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <button href="<?php echo e(route('tables.country.destroy', ['id' => $record['id']])); ?>"
                            ...
                            <a href="<?php echo e(route('tables.country.index')); ?>"
                               role="button"
...
<?php endif; ?>
<?php /**PATH C:\Users\higor\PhpstormProjects\VirtualShelf\resources\views/layout/country/show.blade.php ENDPATH**/ ?>