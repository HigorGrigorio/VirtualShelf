...
<?php $component->withAttributes([]); ?>
    <div class="container px-0">
        <div class="pt-4 pb-3 container-fluid d-flex flex-row justify-content-between px-0">
            <div>
                <a href="<?php echo e(route('tables.country.create')); ?>" class="btn btn-ocean">
                ...
                <table class="table align-middle mb-0 bg-white">
                    ...
                    <?php $__currentLoopData = $pagination; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('tables.country.edit', ['id' => $row->id])); ?>"
                                   role="button"
                                ...
                                <button
                                    data-href="<?php echo e(route('tables.country.destroy', ['id' => $row->id])); ?>"
                                    data-mdb-toggle="modal"
                                    data-mdb-target="#confirm-modal"
                                    class="btn btn-link text-danger btn-rounded btn-sm fw-bold">
                                    <i class="fa fa-trash"></i>
                                </button>
                                <a href="<?php echo e(route('tables.country.show', ['id' => $row->id])); ?>"
                                   role="button"
...
<?php endif; ?>
<?php /**PATH C:\Users\higor\PhpstormProjects\VirtualShelf\resources\views/country/index.blade.php ENDPATH**/ ?>